...
class ComdinheiroProvider(DataProvider):
    ...
    def _fetch_statement(self, portfolio: str, date_inception: str, date_report: str) -> dict[str, pd.DataFrame]:
        ...
        report_url_params = {
            ...
            'el2_movext': '1|1||0',
            'el2_layout': 'V',
            'el2_campo_data_ini': 'data_ini2',
            'el3_benchmarks': 'CDI+IPCAdp',
            'el3_graf_pl': '0',
            'el3_y_min': '',
            'el3_y_max': '',
            'el3_cot_tir': 'cot',
            'el3_campo_data_ini': 'data_ini',
            'el4_benchmarks': '',
            'el4_graf_pl': '2',
            'el4_y_min': '90%pl_min',
            'el4_y_max': '',
            'el4_cot_tir': 'cot',
            'el4_campo_data_ini': 'data_ini',
            ...
            'el11_subclasse': '',
            'el11_filtro': '',
            'el11_campo_data_ini': 'data_ini2',
            'el12_liq': '0+1+3+16+91+360+0+0|corridos|ambos|0|2|pos_bru+acu_pos_bru+per_pos_bru|tabela|0',
            'el13_colunas': 'data_liquidacao+classe+descricao+operacao+quantidade+valor_bruto',
            'el13_filtro': 'Acoes+Clube+Deb+Fund+Gen+MercFut+TitPriv+TitPub+Prev+CriCra+Opcoes+FundOff+Bond',
            'el13_filtro_cv': 'AM+C+DV+IN+SP+T+TIF+VN+V+VT',
            'el13_campo_data_ini': 'data_ini2',
        }
        ...
        try:
            ...
            if 'tables' in data:
                tables = {}
                table_codes = {
                    'tab0': 'Rentabilidade Consolidada',
